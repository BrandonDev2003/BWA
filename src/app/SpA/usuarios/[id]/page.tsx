  ...
  export default function UsuarioDetallePage() {
    ...
    // Descarga sin fetch (evita CORS)
    const a = document.createElement("a");
    a.href = url;

    // Para cross-origin, a veces "download" se ignora,
    // pero abrirá en pestaña y desde ahí el usuario puede descargar.
    a.target = "_blank";
    a.rel = "noreferrer";

    // Nombre sugerido (no siempre lo respetan en cross-origin)
