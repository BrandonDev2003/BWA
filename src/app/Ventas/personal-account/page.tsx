...
export default function PersonalAccountPage() {
  ...
  // ✅ Estado del sidebar (ESTO TE FALTABA)
            ...
            <div className="p-6">
                ...
                <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-5">
                  ...
                  <div className="space-y-3 text-white/85">
                    ...
                    <p>
                      ...
                      <span className="text-white/90 font-semibold">{perfil.cedula || "—"}</span>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-5">
                ...
                <p className="text-white/55 text-sm">
                  Campos como <span className="text-white/70">password</span> no se muestran aquí.
                </p>
              </div>
            </div>
          </div>
